  ...
  const handleDisconnect = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const error = await response.json();
        setError(error.message || 'Error desconectando');
      }
    } catch (error) {
