...
// WhatsApp Simple Connection - Sistema unificado
export const whatsappSimpleConnection = pgTable("whatsapp_simple_connection", {
  id: serial("id").primaryKey(),
  userId: varchar("user_id").notNull().references(() => users.id, { onDelete: 'cascade' }),
  ...
  adminPhoneNumber: varchar("admin_phone_number"),
